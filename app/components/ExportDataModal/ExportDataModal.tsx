...
import { ExportDataModalLinkButton } from "./ExportDataModalLinkButton";
...
export function ExportDataModal() {
  ...
  const zeroTotalRecords =
    totalRecords[dataSetForExport] === 0 ||
    (dataSetForExport === "community-board-budget-requests" &&
      !cbbrAgencyCategoryResponseCheckboxes.some((box) => box.checked)) ||
    (dataSetForExport === "facilities" &&
      (!facilityCategoryCheckboxes.some((box) => box.checked) ||
        !facilityJurisdictionCheckboxes.some((box) => box.checked) ||
        !facilityTypeCheckboxes.some((box) => box.checked)));
          ...
          >
            <Box fontWeight={"bold"} margin={"1rem"}>
              <ModalHeader padding={"0.5rem"}>
                ...
                {zeroTotalRecords
                  ? 0
                  : totalRecords[dataSetForExport]?.toLocaleString(
                      "en-US",
                    )}{" "}
                Records
              </ModalHeader>
            ...
            <ModalFooter>
              <ExportDataModalLinkButton
                downloadLink={downloadLink}
                zeroTotalRecords={zeroTotalRecords}
              />
            </ModalFooter>
          </ModalContent>
        </Modal>
