...
export const facilitySchema = z.object({
  ...
  bin: z
    ...
    .nullish(),
  get facilityJurisdiction() {
    return oversightLevelCategorySchema
      .describe("The type of Oversight Level.")
      .optional();
  },
  get facilityOperatorType() {
    return facilityOperatorTypeSchema
      .describe("The facility type or operator type.")
      .optional();
  },
  categoryId: z.int().describe("The category id of the facility"),
  categoryGroupId: z.int().describe("The category group id of the facility"),
  ...
  alsoAtLocation: z.array(
    z.object({
      ...
      categoryId: z.optional(
        z.int().describe("The category id of the facility"),
      ),
    }),
  ),
});
