...
export const findFacilitiesCsvQueryParamsSchema = z
  .object({
 ...
 */
export const findFacilitiesCsv200Schema = z.string();

/**
 * @description Invalid client request
 */
export const findFacilitiesCsv400Schema = z.lazy(() => errorSchema);

/**
 * @description Server side error
 */
export const findFacilitiesCsv500Schema = z.lazy(() => errorSchema);

export const findFacilitiesCsvQueryResponseSchema = z.lazy(
