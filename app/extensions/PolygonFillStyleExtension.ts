...
export class PolygonFillStyleExtension extends FillStyleExtension {
  ...
  getShaders(extension: this): any {
    ...
    if (shaders) {
      ...
      // line widths appear different on windows devices
      const lineDensity =
