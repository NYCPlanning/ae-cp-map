...
export type CommunityBoardBudgetRequestAgencyCategoryResponseStore = {
...
export const createCommunityBoardBudgetRequestAgencyCategoryResponseStore: StateCreator<
  CommunityBoardBudgetRequestAgencyCategoryResponseStore
> = (set) => ({
